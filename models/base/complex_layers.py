...
from complex_functions import complex_relu, complex_max_pool2d
import torch
...
class _ComplexBatchNorm(Module):
    def __init__(self, num_features, eps=1e-4, momentum=0.1, affine=True, track_running_stats=True):
...
class ComplexBatchNorm2d(_ComplexBatchNorm):
    def forward(self, input_r, input_i):
        ...
        if self.affine:
            input_r, input_i = self.weight[None, :, 0, None, None] * input_r + \
...
class ComplexBatchNorm1d(_ComplexBatchNorm):
    def forward(self, input_r, input_i):
        ...
        # input_r = Rrr[None, :]*input_r+Rri[None, :]*input_i
        # input_i = Rii[None, :]*input_i+Rri[None, :]*input_r
        ...
        # input_r = self.weight[None, :, 0] * input_r + self.weight[None, :, 2] * input_i + self.bias[None, :, 0]
        # input_i = self.weight[None, :, 2] * input_r + self.weight[None, :, 1] * input_i + self.bias[None, :, 1]

        c0 = Rrr * self.weight[None, :, 0] + Rri * self.weight[None, :, 2]
        c1 = Rri * self.weight[None, :, 0] + Rii * self.weight[None, :, 2]
        c2 = Rri * self.weight[None, :, 1] + Rrr * self.weight[None, :, 2]
        c3 = Rii * self.weight[None, :, 1] + Rri * self.weight[None, :, 2]
        b0 = self.bias[None, :, 0] - mean[None, :, 0] * c0 - mean[None, :, 1] * c1
        b1 = self.bias[None, :, 1] - mean[None, :, 0] * c2 - mean[None, :, 1] * c3
        input_r, input_i = c0 * input_r + c1 * input_i + b0, c2 * input_r + c3 * input_i + b1
